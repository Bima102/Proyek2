                            ...
                            <form method="post" action="{{ route('dasboardsuplier-create-payment') }}">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="number" class="form-control" id="telur" name="telur"
                                            placeholder="Kg" onchange="calculatePrice()" required>
                                    </div>
                                    <hr class="my-4">
                                    ...
                                    <div class="my-3">
                                        <div class="form-check">
                                            <input id="credit" name="paymentMethod" type="radio"
                                                class="form-check-input" onclick="setFieldValue()" value="2132131"
                                                checked required>
                                        ...
                                        <div class="form-check">
                                            <input id="paypal" name="paymentMethod" type="radio"
                                                class="form-check-input" onclick="setFieldValue()" value="435435435"
                                                required>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control" id="namabayar" name="payment_method"
                                            required>
                                        <div class="invalid-feedback">
                                    ...
                                    <script>
                                        function setFieldValue() {
                                            var creditRadio = document.querySelector(
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="number" class="form-control" id="harga" placeholder="Rp"
                                            name="harga" readonly>
                                    </div>
                                    <hr class="my-4">
