    ...
    <div class="auto-group-ycji-aFz">
      <div class="auto-group-kke8-vak">
        <div class="frame-1321314404-qxc">
          <p class="telur-tersisa-NSk">Pendapatan Bulan Ini</p>
          <p class="kg-67r">100.000 </p>
        ...
        <div class="frame-1321314414-iQ8">
          <p class="harga-telur-perkg-dmz">Pendapatan Hari Ini</p>
          <p class="rp31000-LgQ">31,000</p>
          <p class="tekan-untuk-mengganti-harga-swE"><button class="button" data-modal="modalTwo">Tekan untuk menambah pendapatan</button></p>
          <div id="modalTwo" class="modal">
            <div class="modal-content">
              <div class="contact-form">
                <span class="close">&times;</span>
                <form action="/">
                  <h2>Menambah Pendapatan</h2>
                  <div>
