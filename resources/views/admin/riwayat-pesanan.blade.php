  ...
  <div class="auto-group-6irn-SDE">
    <div class="auto-group-neks-nH6">
      <div class="frame-58-Wit">
        <p class="total-pendapatan-2x8">Total Pendapatan </p>
        <p class="rp100000000-Yfa">Rp.100.000.000</p>
      </div>
      <div class="frame-1321314409-qPn">
        <p class="total-pendapatan-bulan-ini-Bc4">Total Pendapatan Bulan Ini</p>
        <p class="rp100000000-Hf6">Rp.100.000.000</p>
      </div>
      <div class="frame-1321314410-CGG">
        <p class="total-pendapatan-hari-ini-78L">Total Pendapatan Hari Ini</p>
