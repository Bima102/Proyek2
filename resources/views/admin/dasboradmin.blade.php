      ...
      <div class="frame-9UC">
        ...
        <div class="content-kyn">
          <div class="icon-text-Wi4">
            <div class="text-fax">  Dashboard</div>
          </div>
        </div>
        <div class="content-kcQ">
          <div class="text-7Sx">  Data Produk</div>
        </div>
        <div class="content-zWk">
          <div class="text-YYG"> Riwayat Pesanan</div>
        </div>
        <div class="content-eLQ">
          <div class="text-bFe">
            <p class="riwayat-barang-masuk-MEp">
             Riwayat Barang
            <br/>
             Masuk
            </p>
        ...
        <div class="content-eji">
          <div class="text-1KN">
            <p class="buat-pesanan-ke-suplier-Mu2">Buat Pesanan Ke Suplier</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="auto-group-ycji-aFz">
    <div class="auto-group-kke8-vak">
      <div class="frame-1321314404-qxc">
        ...
        <p class="tekan-untuk-menambah-stok-telur-q5S">Tekan untuk menambah stok telur</p>
      </div>
      <div class="frame-1321314414-iQ8">
        <p class="harga-telur-perkg-dmz">Harga Telur Per,Kg</p>
        <p class="rp31000-LgQ">Rp.31,000</p>
        <p class="tekan-untuk-mengganti-harga-swE">Tekan untuk mengganti harga</p>
      </div>
    </div>
