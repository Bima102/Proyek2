                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form id="delete-form" action="{{ route('riwayharga-create-payment') }}"
                                            method="post">
                                            @csrf
                                            <input type="text" class="form-control" id="namabayar" name="harga"
                                                required>
                                            <p class="tekan-untuk-mengganti-harga-swE">
                                                <button class="btn btn-primary" type="submit">Ganti Harga Per
                                                    KG</button>
                                            </p>
                                        </form>
                                    </div>
                        ...
                        <table class="table table-striped table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form id="delete-form"
                                            action="{{ route('riwayharga-delete-payment', ['id' => $item->id]) }}"
                                            method="post">
                                            @csrf
