                    ...
                    <div class="col-md-3">
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"></p>
                                <a class="btn btn-primary" href="/bayar-request?weight=1" id="pesanSekarangBtn1">pesan
                                    sekarang</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"></p>
                                <a class="btn btn-primary" href="/bayar-request?weight=10" id="pesanSekarangBtn10">pesan
                                    sekarang</a>
                            </div>
                        </div>
                    </div>
